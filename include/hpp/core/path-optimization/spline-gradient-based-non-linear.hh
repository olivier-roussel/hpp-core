...
namespace hpp {
  namespace core {
    ...
    namespace pathOptimization {
      ...
      class HPP_CORE_DLLAPI SplineGradientBasedNonLinear : public SplineGradientBasedAbstract<_PolynomeBasis, _SplineOrder>
      {
        public:
          ...
          typedef boost::shared_ptr<SplineGradientBasedNonLinear> Ptr_t;
        ...
        protected:
          ...
          SplineGradientBasedNonLinear (const Problem& problem);
          ...
          virtual void getNumericalConstraints (const PathVectorPtr_t& init,
              const Splines_t& splines,
              NumericalConstraintss_t& numCsPerPath,
              NumericalConstraintss_t& numCsPerWaypoint) const;

          void getNumericalConstraintsOnPath (const PathPtr_t& path,
          ...
          void makeConstraintsOnProblemVariable (
              NumericalConstraintss_t& numCsPerPath,
              NumericalConstraintss_t& numCsPerWaypoint) const;
